...
function App() {
  ...
  const [workflowIndicator, setWorkflowIndicator] = useState(null)
  ...
  const [findItemModalOpen, setFindItemModalOpen] = useState(false)
  const [selectedCategory, setSelectedCategory] = useState('all')
  const [itemSearchQuery, setItemSearchQuery] = useState('')
  const [selectedItem, setSelectedItem] = useState(null)
  const [itemQuantity, setItemQuantity] = useState(1)
  const [itemVariant, setItemVariant] = useState('')
  const [moqSelection, setMoqSelection] = useState(null)
  const open = Boolean(anchorEl)

  // Mock catalog data based on EIS products
  const catalogData = [
    { id: 1, name: 'Industrial Wipers - White Cotton Rags', category: 'Janitorial', sku: 'RAG-001', variants: ['10 lb box', '25 lb box', '50 lb box'] },
    { id: 2, name: 'Safety Glasses - Clear Lens', category: 'Safety', sku: 'SAF-100', variants: ['Single pair', '12 pack', '24 pack'] },
    { id: 3, name: 'Nitrile Gloves - Powder Free', category: 'Safety', sku: 'GLV-200', variants: ['Small', 'Medium', 'Large', 'X-Large'] },
    { id: 4, name: 'Pallet Wrap - Stretch Film 18"', category: 'Packaging', sku: 'PKG-300', variants: ['1500ft roll', '3000ft roll'] },
    { id: 5, name: 'Corrugated Boxes - 12x12x12', category: 'Packaging', sku: 'BOX-400', variants: ['Bundle of 25', 'Bundle of 50', 'Bundle of 100'] },
    { id: 6, name: 'Hand Truck - Aluminum 500lb', category: 'Material Handling', sku: 'MH-500', variants: ['Standard', 'Heavy Duty'] },
    { id: 7, name: 'Floor Cleaner - Multi-Surface', category: 'Janitorial', sku: 'CLN-600', variants: ['1 Gallon', '5 Gallon', '55 Gallon Drum'] },
    { id: 8, name: 'Hard Hat - ANSI Approved', category: 'Safety', sku: 'SAF-700', variants: ['White', 'Yellow', 'Orange', 'Blue'] },
    { id: 9, name: 'Shipping Labels - 4x6 Thermal', category: 'Packaging', sku: 'LBL-800', variants: ['500 labels', '1000 labels', '2000 labels'] },
    { id: 10, name: 'Drum Dolly - 55 Gallon', category: 'Material Handling', sku: 'MH-900', variants: ['Standard', 'Swivel Casters'] },
    { id: 11, name: 'Mop Head - Cotton Blend', category: 'Janitorial', sku: 'MOP-100', variants: ['16 oz', '24 oz', '32 oz'] },
    { id: 12, name: 'Safety Vest - High Visibility', category: 'Safety', sku: 'VES-200', variants: ['Small', 'Medium', 'Large', 'X-Large', '2X-Large'] },
    { id: 13, name: 'Bubble Wrap - 12" Wide', category: 'Packaging', sku: 'BUB-300', variants: ['50ft roll', '100ft roll', '250ft roll'] },
    { id: 14, name: 'Pallet Jack - 5500lb Capacity', category: 'Material Handling', sku: 'PJ-400', variants: ['27" Width', '48" Width'] },
    { id: 15, name: 'Trash Bags - 55 Gallon Heavy Duty', category: 'Janitorial', sku: 'BAG-500', variants: ['50 count', '100 count', '200 count'] },
    { id: 16, name: 'Ear Plugs - Disposable Foam', category: 'Safety', sku: 'EAR-600', variants: ['50 pair box', '200 pair box'] },
    { id: 17, name: 'Tape Dispenser - 3" Core', category: 'Packaging', sku: 'TAP-700', variants: ['Hand-held', 'Desktop'] },
    { id: 18, name: 'Shelving Unit - Industrial Wire', category: 'Material Handling', sku: 'SHF-800', variants: ['4 Shelf', '5 Shelf', '6 Shelf'] },
  ]
  ...
  const customersData = [
    { name: 'Summit Home Goods', revenue: '$21.2M', marginPerPallet: '$409', logisticsMarginPercent: '33.3', marginPercent: '39.2', walmartPercent: '11', ltlVariance: '+$18', strategicInsights: [], hasAIRecommendation: true },
    { name: 'Cascade Brands Inc', revenue: '$3.9M', marginPerPallet: '$159', logisticsMarginPercent: '32.4', marginPercent: '41.0', walmartPercent: '15', ltlVariance: '+$12', strategicInsights: ['M'], hasAIRecommendation: false },
    { name: 'Prairie Grain Co', revenue: '$2.7M', marginPerPallet: '$279', logisticsMarginPercent: '38.0', marginPercent: '39.8', walmartPercent: '7', ltlVariance: '+$25', strategicInsights: ['M'], hasAIRecommendation: false },
    { name: 'Heritage Beverage', revenue: '$1.1M', marginPerPallet: '$235', logisticsMarginPercent: '28.6', marginPercent: '35.8', walmartPercent: '19', ltlVariance: '-$8', strategicInsights: ['L'], hasAIRecommendation: false },
    { name: 'Stellar Confections', revenue: '$900K', marginPerPallet: '$454', logisticsMarginPercent: '47.0', marginPercent: '42.9', walmartPercent: '8', ltlVariance: '+$22', strategicInsights: ['!'], hasAIRecommendation: false },
    { name: 'Artisan Wine Group', revenue: '$585,768', marginPerPallet: '$402', logisticsMarginPercent: '35.1', marginPercent: '12.3', walmartPercent: '8', ltlVariance: '-$42', strategicInsights: ['M', 'L'], hasAIRecommendation: true },
    { name: 'Vitality Foods LLC', revenue: '$892,450', marginPerPallet: '$230', logisticsMarginPercent: '31.1', marginPercent: '16.8', walmartPercent: '12', ltlVariance: '+$15', strategicInsights: [], hasAIRecommendation: false },
    { name: 'Horizon Consumer Group', revenue: '$1,245,880', marginPerPallet: '$290', logisticsMarginPercent: '38.4', marginPercent: '11.2', walmartPercent: '18', ltlVariance: '+$8', strategicInsights: ['M'], hasAIRecommendation: true },
    { name: 'Golden Grain Foods', revenue: '$324,560', marginPerPallet: '$390', logisticsMarginPercent: '30.6', marginPercent: '17.5', walmartPercent: '5', ltlVariance: '+$22', strategicInsights: [], hasAIRecommendation: false },
    { name: 'Pacific Gourmet Inc', revenue: '$1,567,230', marginPerPallet: '$345', logisticsMarginPercent: '29.0', marginPercent: '10.8', walmartPercent: '6', ltlVariance: '-$55', strategicInsights: ['M', 'L'], hasAIRecommendation: true },
    { name: 'Sunrise Organic Brands', revenue: '$2,145,900', marginPerPallet: '$211', logisticsMarginPercent: '32.6', marginPercent: '18.2', walmartPercent: '31', ltlVariance: '+$35', strategicInsights: ['W'], hasAIRecommendation: false },
    { name: 'Harvest Health Products', revenue: '$456,280', marginPerPallet: '$340', logisticsMarginPercent: '34.0', marginPercent: '13.1', walmartPercent: '9', ltlVariance: '+$12', strategicInsights: ['M'], hasAIRecommendation: false }
  ]
  ...
  const handleAttachFile = () => {
    ...
    if (currentStep === 25) {
      ...
      setMessages([{
        type: 'user',
        text: 'User attached "Apex\'s client data po history.xlsx"',
        timestamp: '03:06 PM'
      }])
      ...
      setMessages(prev => [...prev, {
        type: 'user',
        text: 'User attached "Apex\'s client data po history (updated).xlsx"',
        timestamp: '03:07 PM'
      }])
      ...
      setMessages(prev => [...prev, {
        type: 'user',
        text: 'User attached "ApexQuote.HTML"',
        timestamp: '03:10 PM'
      }])
  ...
  const handleFindItem = () => {
    handleClose()
    setFindItemModalOpen(true)
  }

  const handleCloseFindItem = () => {
    setFindItemModalOpen(false)
  ...
  const handleSelectItem = (item) => {
    ...
    setItemVariant(item.variants[0])
  }

  const handleAddItemToQuote = () => {
    if (selectedItem && itemVariant) {
      setMessages(prev => [...prev, {
        type: 'user',
        text: `Added ${itemQuantity}x ${selectedItem.name} (${itemVariant}) to quote`,
  ...
  const startFindLikeItemsDemo = () => {
    // Start the demo by pre-populating the input field
    setMessages([])
    setChatInput('Heavy-duty gloves for warehouse handling, need good grip')
    setWorkflowIndicator('send-initial')
  }

  const handleFindLikeItemsDemoSubmit = () => {
    // Add user message
    ...
    // After 3 seconds, show the product matches
    setTimeout(() => {
      setIsThinking(false)
      setMessages(prev => [...prev, {
        type: 'system',
        text: `I found 3 products matching "Heavy-duty gloves for warehouse handling, need good grip":

1. NITRILE GLOVES - POWDER FREE
   Powder-free nitrile gloves with textured grip. Ideal for warehouse, material handling, and general industrial use.
   SKU: GLV-200 — Available in Small, Medium, Large, X-Large
   Matches heavy-duty requirement, excellent grip performance

2. WORK GLOVES - LEATHER PALM
   Premium leather palm work gloves with reinforced fingertips. Superior grip and durability for heavy materials.
   SKU: GLV-250 — Available in Medium, Large, X-Large
   Matches warehouse handling requirement, maximum grip and protection

3. CUT-RESISTANT GLOVES - LEVEL 5
   High-performance cut-resistant gloves with textured coating for superior grip in wet/dry conditions.
   SKU: GLV-300 — Available in Small, Medium, Large, X-Large
   Matches industrial use requirement, exceeds standard grip specifications`,
        timestamp: new Date().toLocaleTimeString('en-US', { hour: 'numeric', minute: '2-digit' }),
        isProductList: true
      }])
      setCurrentStep(1) // Move to step 1 (waiting for item selection)

      // After showing products, ask for order size and pre-populate answer
      setTimeout(() => {
        setMessages(prev => [...prev, {
          type: 'system',
          text: 'Which item would you like to order, and what quantity do you need?',
          timestamp: new Date().toLocaleTimeString('en-US', { hour: 'numeric', minute: '2-digit' })
        }])
        // Pre-populate the input with "2"
        setTimeout(() => {
          setChatInput('2')
          setWorkflowIndicator('send-item')
        }, 500)
      }, 1000)
    }, 3000)
  }

  const handleItemSelectionSubmit = () => {
    // User selected item (e.g., "2")
    setMessages(prev => [...prev, {
      type: 'user',
      text: chatInput,
      timestamp: new Date().toLocaleTimeString('en-US', { hour: 'numeric', minute: '2-digit' })
    ...
    // After 2 seconds, ask for quantity/order size
    setTimeout(() => {
      setIsThinking(false)
      setMessages(prev => [...prev, {
        type: 'system',
        text: 'You still need to add quantity. This item is sold in cases. How many cases would you like?',
        timestamp: new Date().toLocaleTimeString('en-US', { hour: 'numeric', minute: '2-digit' })
      }])
      setCurrentStep(2) // Move to step 2 (waiting for quantity)

      // Pre-populate with a quantity
      setTimeout(() => {
        setChatInput('15 cases')
        setWorkflowIndicator('send-quantity')
      }, 500)
    }, 2000)
  }

  const handleQuantitySubmit = () => {
    // User entered quantity (e.g., "15 cases")
    setMessages(prev => [...prev, {
      type: 'user',
      text: chatInput,
      timestamp: new Date().toLocaleTimeString('en-US', { hour: 'numeric', minute: '2-digit' })
    ...
    // After 2 seconds, show MOQ blocker
    setTimeout(() => {
      setIsThinking(false)
      setCurrentStep(3) // Move to step 3 (MOQ blocker)
      setWorkflowIndicator('moq-increase')
    }, 2000)
  }

  const handleMOQOption1 = () => {
    setMoqSelection(1)
    setTimeout(() => {
      setMessages(prev => [...prev,
        {
          type: 'user',
          text: '✓ Accept pricing at current quantity',
          timestamp: new Date().toLocaleTimeString('en-US', { hour: 'numeric', minute: '2-digit' })
        },
        {
          type: 'system',
  ...
  const handleMOQOption2 = () => {
    ...
    setTimeout(() => {
      setMessages(prev => [...prev,
        {
          type: 'user',
          text: '✓ Increase quantity to meet minimum',
          timestamp: new Date().toLocaleTimeString('en-US', { hour: 'numeric', minute: '2-digit' })
        },
        {
          type: 'system',
      ...
      setCurrentStep(4)
      setWorkflowIndicator('add-more-items')
    }, 500)
  }

  const handleMOQOption3 = () => {
    setMoqSelection(3)
    setTimeout(() => {
      setMessages(prev => [...prev,
        {
          type: 'user',
          text: '✓ Remove this item from the quote',
          timestamp: new Date().toLocaleTimeString('en-US', { hour: 'numeric', minute: '2-digit' })
        },
        {
          type: 'system',
          text: 'Item removed. You can add different products or generate a quote with your current selections.',
          timestamp: new Date().toLocaleTimeString('en-US', { hour: 'numeric', minute: '2-digit' })
        }
      ])
      setCurrentStep(4)
  ...
  const handleAddMoreItems = () => {
    setMessages(prev => [...prev, {
      type: 'system',
      text: 'What additional items would you like to add to your quote?',
      timestamp: new Date().toLocaleTimeString('en-US', { hour: 'numeric', minute: '2-digit' })
    }])
    setChatInput('Looking for industrial safety goggles with anti-fog coating')
    setCurrentStep(5)
    setWorkflowIndicator('send-second-search')
  }

  const handleSecondProductSearch = () => {
    // Add user message
    const userMessage = chatInput
    setMessages(prev => [...prev, {
      type: 'user',
    ...
    setTimeout(() => {
      ...
      setMessages(prev => [...prev, {
        type: 'system',
        text: `I found 3 products matching "industrial safety goggles with anti-fog coating":

1. SAFETY GLASSES - CLEAR LENS
   Clear polycarbonate safety glasses with anti-fog coating. Meets ANSI Z87.1 standards.
   SKU: SAF-100 — Available in Single pair, 12 pack, 24 pack
   Matches anti-fog requirement, standard industrial protection

2. SAFETY GOGGLES - ANTI-FOG
   Premium safety goggles with anti-fog and anti-scratch coating. Chemical splash protection, indirect ventilation.
   SKU: SAF-150 — Available in Single unit, 6 pack, 12 pack
   Matches industrial requirement, superior fog resistance

3. SAFETY GOGGLES - FULL SEAL
   Full-seal safety goggles with advanced anti-fog coating. Maximum protection for industrial environments.
   SKU: SAF-200 — Available in Single unit, 6 pack
   Matches heavy-duty industrial use, premium anti-fog performance`,
        timestamp: new Date().toLocaleTimeString('en-US', { hour: 'numeric', minute: '2-digit' }),
        isProductList: true
      }])
      setCurrentStep(6) // Move to step 6

      // After showing products, ask which one they want
      setTimeout(() => {
        setMessages(prev => [...prev, {
          type: 'system',
          text: 'Which item would you like to order, and what quantity do you need?',
        ...
        // Pre-populate the input with item and quantity
        setTimeout(() => {
          setChatInput('I want item 2, 400 quantity')
          setWorkflowIndicator('send-second-item')
        }, 500)
      }, 1000)
    }, 3000)
  }

  const handleSecondItemSelection = () => {
    // User selected item "2" with quantity 400
    setMessages(prev => [...prev, {
      type: 'user',
      text: chatInput,
      timestamp: new Date().toLocaleTimeString('en-US', { hour: 'numeric', minute: '2-digit' })
    ...
    // After 2 seconds, confirm addition
    setTimeout(() => {
      setIsThinking(false)
      setMessages(prev => [...prev, {
        type: 'system',
        text: 'SAFETY GOGGLES - ANTI-FOG (400 units) added to your quote. You now have 2 items in your quote.',
        timestamp: new Date().toLocaleTimeString('en-US', { hour: 'numeric', minute: '2-digit' })
      }])
      setCurrentStep(7) // Show follow-up card again
      setWorkflowIndicator('generate-quote')
    }, 2000)
  }

  const handleGenerateQuoteFromDemo = () => {
    setMessages(prev => [...prev, {
      type: 'system',
    ...
    setIsThinking(true)
    const nextStep = currentStep === 15 ? 16 : 8
    setCurrentStep(nextStep)
    setWorkflowIndicator(null)

    // Show quote output after delay
    setTimeout(() => {
      setIsThinking(false)
      setMessages(prev => [...prev, {
        type: 'system',
  ...
  // Bulk Reorder Demo Handlers
  const startBulkReorderDemo = () => {
    setMessages([])
    setChatInput('GLV-250 20 cases, SAF-150 400 units, RAG-001 10 boxes, GLV-200 50 packs, WIP-100 25 rolls')
    setWorkflowIndicator('send-bulk-initial')
  }

  const handleBulkReorderSubmit = () => {
    const userMessage = chatInput
    setMessages(prev => [...prev, {
      type: 'user',
      text: userMessage,
    ...
    setTimeout(() => {
      ...
      setMessages(prev => [...prev, {
        type: 'system',
        text: '4/5 items found. Let\'s clarify 1 item: "WIP-100"',
        timestamp: new Date().toLocaleTimeString('en-US', { hour: 'numeric', minute: '2-digit' })
      }])
      setCurrentStep(20) // Bulk reorder starts at step 20

      setTimeout(() => {
        setMessages(prev => [...prev, {
          type: 'system',
          text: `I found 3 similar products for "WIP-100":

1. INDUSTRIAL WIPERS - WHITE COTTON RAGS
   Premium white cotton wipers for industrial cleaning. Highly absorbent and reusable.
   SKU: RAG-001 — Available in 10 lb box, 25 lb box, 50 lb box

2. SHOP TOWELS - BLUE ROLL
   Blue shop towel rolls for general purpose cleaning. Perforated for easy use.
   SKU: TOWEL-150 — Available in Single roll, 12 pack, 24 pack

3. CLEANING WIPES - DISPOSABLE
   Pre-moistened disposable cleaning wipes. Ideal for quick cleanup tasks.
   SKU: WIPE-200 — Available in 100 count, 500 count, 1000 count`,
          timestamp: new Date().toLocaleTimeString('en-US', { hour: 'numeric', minute: '2-digit' }),
          isProductList: true
        }])
        ...
        setTimeout(() => {
          setMessages(prev => [...prev, {
            type: 'system',
            text: 'Use a number to identify which SKU matches, or describe your product.',
            timestamp: new Date().toLocaleTimeString('en-US', { hour: 'numeric', minute: '2-digit' })
          }])
          setTimeout(() => {
            setChatInput('1')
            setWorkflowIndicator('send-bulk-item')
          }, 500)
        }, 1000)
      }, 1000)
    }, 2000)
  ...
  const handleBulkItemSelection = () => {
    ...
    setTimeout(() => {
      ...
      setMessages(prev => [...prev, {
        type: 'system',
        text: 'You originally requested 25 rolls. INDUSTRIAL WIPERS - WHITE COTTON RAGS is sold in boxes, not rolls. There are 12 rolls per box, so 2 boxes would give you 24 rolls (close to your request of 25). Do you want 2 boxes?',
        timestamp: new Date().toLocaleTimeString('en-US', { hour: 'numeric', minute: '2-digit' })
      }])
      setCurrentStep(21)
      setTimeout(() => {
        setChatInput('Yes')
        setWorkflowIndicator('send-bulk-confirm')
      }, 500)
    }, 2000)
  }

  const handleBulkQuantityConfirm = () => {
    setMessages(prev => [...prev, {
      type: 'user',
      text: chatInput,
      timestamp: new Date().toLocaleTimeString('en-US', { hour: 'numeric', minute: '2-digit' })
    ...
    setTimeout(() => {
      ...
      setMessages(prev => [...prev, {
        type: 'system',
        text: 'All 5 items validated successfully. You can generate a quote or add more products.',
        timestamp: new Date().toLocaleTimeString('en-US', { hour: 'numeric', minute: '2-digit' })
      }])
      setCurrentStep(22)
  ...
  const startLikeItemPricingDemo = () => {
    // Start the like-item pricing demo
    setMessages([])
    setChatInput('I need pricing for safety vests, SKU VES-200, but with our company logo printed on the back in 2 colors instead of plain')
    setWorkflowIndicator('send-like-item-initial')
  }

  const handleLikeItemPricingInitialSubmit = () => {
    // User submitted their like-item request
    const userMessage = chatInput
    setMessages(prev => [...prev, {
      type: 'user',
      text: userMessage,
    ...
    // After 2.5 seconds, acknowledge the base SKU and ask for details
    setTimeout(() => {
      setIsThinking(false)
      setMessages(prev => [...prev, {
        type: 'system',
        text: 'I found your base SKU: VES-200 - Safety Vest High Visibility (Small, Medium, Large, X-Large, 2X-Large). Standard pricing is available, but you\'re requesting a custom variant with 2-color logo printing. To provide accurate budgetary pricing, I need a few more details:',
        timestamp: new Date().toLocaleTimeString('en-US', { hour: 'numeric', minute: '2-digit' })
      }])
      ...
      setTimeout(() => {
        setMessages(prev => [...prev, {
          type: 'system',
          text: 'What quantity are you looking at, and what size distribution do you need?',
          timestamp: new Date().toLocaleTimeString('en-US', { hour: 'numeric', minute: '2-digit' })
        }])
        setCurrentStep(11) // Like-item workflow step 1

        // Pre-populate response
        setTimeout(() => {
          setChatInput('Need 200 total - mostly Large and X-Large, about 80 Large, 80 X-Large, 40 Medium')
          setWorkflowIndicator('send-like-item-quantity')
        }, 500)
      }, 1000)
    }, 2500)
  }

  const handleLikeItemQuantitySubmit = () => {
    ...
    // After 2 seconds, ask about the printing details
    setTimeout(() => {
      setIsThinking(false)
      setMessages(prev => [...prev, {
        type: 'system',
        text: 'Perfect - 200 safety vests with that size distribution. For the 2-color logo printing on the back, can you describe what you need? (e.g., logo size, colors, placement)',
        timestamp: new Date().toLocaleTimeString('en-US', { hour: 'numeric', minute: '2-digit' })
      }])
      setCurrentStep(12) // Like-item workflow step 2

      // Pre-populate response
      setTimeout(() => {
        setChatInput('Company logo centered on back - approximately 10x8 inches, navy blue and white ink')
        setWorkflowIndicator('send-like-item-variant')
      }, 500)
    }, 2000)
  }

  const handleLikeItemVariantSubmit = () => {
    // User provided variant details
    setMessages(prev => [...prev, {
      type: 'user',
      text: chatInput,
      timestamp: new Date().toLocaleTimeString('en-US', { hour: 'numeric', minute: '2-digit' })
    ...
    // After 3 seconds, show confirmation with heads-up
    setTimeout(() => {
      setIsThinking(false)
      setMessages(prev => [...prev,
        {
          type: 'system',
          text: 'VES-200 Safety Vests with custom 2-color logo printing (200 units) added to your quote.',
          timestamp: new Date().toLocaleTimeString('en-US', { hour: 'numeric', minute: '2-digit' })
        },
        {
          type: 'system',
          text: 'Standard lead time is longer for custom printing. This note will be added to your quote.',
          timestamp: new Date().toLocaleTimeString('en-US', { hour: 'numeric', minute: '2-digit' }),
          isHeadsUp: true,
          showUnderstandButton: true
        }
      ])
      setCurrentStep(13) // Show understand button state
    }, 3000)
  }

  const handleLikeItemConfirmSubmit = () => {
    ...
    // After 2 seconds, confirm submission
    setTimeout(() => {
      setIsThinking(false)
      setMessages(prev => [...prev, {
        type: 'system',
        text: 'Perfect! I\'ve submitted your request for formal quote #QQ-2847 for VES-200 Safety Vests with custom 2-color logo printing. Our team will review the logo specifications and provide final pricing and lead time within 24 hours. You\'ll receive an email confirmation shortly.',
        timestamp: new Date().toLocaleTimeString('en-US', { hour: 'numeric', minute: '2-digit' }),
        isSuccess: true
      }])
      setCurrentStep(14) // Workflow complete
    }, 2000)
  }
...
I'll match your description to our products, confirm quantities, and help you build a quote`,
  ...
  const handleChatEntryPoint = () => {
    ...
    setTimeout(() => {
      ...
      setMessages(prev => [...prev, {
        type: 'system',
        text: 'Perfect! I\'ve pulled the relevant details from your CRM for Apex\'s IL Consolidation Program. I found their account history, current rates, and shipping patterns with 117 shipments across 4 retailers. Let me validate the data before we proceed.',
        timestamp: new Date().toLocaleTimeString('en-US', { hour: 'numeric', minute: '2-digit' })
      }])
  ...
  // Mock data for chat history with demo scenarios
  const clients = [
    {
      id: 1,
      ...
      quoteCount: 1,
      demos: [
        { title: 'Find matching products using natural language descriptions', type: 'find-like-items', hasPlay: true }
      ]
    },
    {
      id: 2,
      ...
      quoteCount: 1,
      demos: [
        { title: 'Like-item pricing - Custom attributes for budgetary quote', type: 'like-item-pricing', hasPlay: true }
      ]
    },
    {
      id: 3,
      ...
      quoteCount: 1,
      demos: [
        { title: 'Bulk reorder - 5 known SKUs at once', type: 'bulk-reorder', hasPlay: true }
      ]
    },
    {
      id: 4,
    ...
    <Box sx={{ display: 'flex', flexDirection: 'column', height: '100vh', bgcolor: '#fafafa' }}>
                        ...
                        {demo.hasPlay && (
                          <IconButton
                            ...
                            onClick={() => {
                              ...
                              setCurrentStep(0)
                              setCurrentApp('quick-quote')
                              // Start the demo based on type
                              if (demo.type === 'find-like-items') {
                                startFindLikeItemsDemo()
                              } else if (demo.type === 'like-item-pricing') {
      ...
      <Box sx={{ flexGrow: 1, display: 'flex', flexDirection: 'column' }}>
        ...
        >
          ...
          <Button
            variant="contained"
            onClick={() => setSelectedClient(selectedClient ? null : 'Apex')}
                    ...
                    {message.isHeadsUp && (
                      <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 1.5 }}>
                        ...
                        <Box sx={{ flex: 1 }}>
                          ...
                          <Typography variant="body2" sx={{
                            color: '#333',
                            mb: message.showRatesPreview ? 2 : (message.showFinalizeButton ? 2 : 0),
                            whiteSpace: message.isProductList ? 'pre-wrap' : 'normal',
                            lineHeight: message.isProductList ? 1.7 : 1.5,
                            fontSize: message.isProductList ? '14px' : '14px'
                          }}>
                            {message.text}
                          </Typography>
                          ...
                          {message.showUnderstandButton && (
                            <Button
                              variant="contained"
                              onClick={() => {
                                // Add user's "I understand" message and system response
                                setMessages(prev => [...prev,
                                  {
                                    type: 'user',
                                    text: 'I understand',
                                ...
                                // Show follow-up card with options
                                setCurrentStep(15)
                                setWorkflowIndicator('generate-quote')
                              }}
                              sx={{
                      ...
                      <Box sx={{ width: '100%' }}>
                        ...
                        <Box sx={{ mb: 3, border: '1px solid #e0e0e0', borderRadius: 1, overflow: 'hidden' }}>
                          <Box sx={{
                            ...
                            <Typography variant="caption" sx={{ fontWeight: 600, color: '#666' }}>SKU</Typography>
                            <Typography variant="caption" sx={{ fontWeight: 600, color: '#666' }}>Order Size</Typography>
                            <Typography variant="caption" sx={{ fontWeight: 600, color: '#666' }}>Price/Unit</Typography>
                            <Typography variant="caption" sx={{ fontWeight: 600, color: '#666' }}>Line Total</Typography>
                            <Typography variant="caption" sx={{ fontWeight: 600, color: '#666' }}>Notes</Typography>
                          </Box>

                          {message.quoteType === 'like-item-vests' ? (
                            <>
                              <Box sx={{
                                display: 'grid',
                                gridTemplateColumns: '2fr 1fr 1fr 1.5fr 1fr',
                                ...
                                <Box>
                                  <Typography variant="body2" sx={{ fontWeight: 600 }}>VES-200-L</Typography>
                                  <Typography variant="caption" sx={{ color: '#666' }}>SAFETY VEST - LARGE (Custom 2-color logo)</Typography>
                                </Box>
                                <Typography variant="body2">80 units</Typography>
                                <Typography variant="body2">$10.50 - $12.75</Typography>
                                <Typography variant="body2">$840 - $1,020</Typography>
                              ...
                              <Box sx={{
                                ...
                                <Box>
                                  <Typography variant="body2" sx={{ fontWeight: 600 }}>VES-200-XL</Typography>
                                  <Typography variant="caption" sx={{ color: '#666' }}>SAFETY VEST - X-LARGE (Custom 2-color logo)</Typography>
                                </Box>
                                <Typography variant="body2">80 units</Typography>
                                <Typography variant="body2">$10.50 - $12.75</Typography>
                                <Typography variant="body2">$840 - $1,020</Typography>
                              ...
                              <Box sx={{
                                ...
                                <Box>
                                  <Typography variant="body2" sx={{ fontWeight: 600 }}>VES-200-M</Typography>
                                  <Typography variant="caption" sx={{ color: '#666' }}>SAFETY VEST - MEDIUM (Custom 2-color logo)</Typography>
                                </Box>
                                <Typography variant="body2">40 units</Typography>
                                <Typography variant="body2">$10.50 - $12.75</Typography>
                                <Typography variant="body2">$420 - $510</Typography>
                                <Typography variant="body2" sx={{ color: '#ff9800', fontStyle: 'italic' }}>
                                  Custom printing
                                </Typography>
                              </Box>
                            </>
                          ) : message.quoteType === 'bulk-reorder' ? (
                            <>
                              <Box sx={{
                                display: 'grid',
                                gridTemplateColumns: '2fr 1fr 1fr 1.5fr 1fr',
                                ...
                                <Box>
                                  <Typography variant="body2" sx={{ fontWeight: 600 }}>GLV-250</Typography>
                                  <Typography variant="caption" sx={{ color: '#666' }}>WORK GLOVES - LEATHER PALM</Typography>
                                </Box>
                                <Typography variant="body2">20 cases</Typography>
                                <Typography variant="body2">$18.50</Typography>
                                <Typography variant="body2">$3,700</Typography>
                              ...
                              <Box sx={{
                                ...
                                <Box>
                                  <Typography variant="body2" sx={{ fontWeight: 600 }}>SAF-150</Typography>
                                  <Typography variant="caption" sx={{ color: '#666' }}>SAFETY GOGGLES - ANTI-FOG</Typography>
                                </Box>
                                <Typography variant="body2">400 units</Typography>
                                <Typography variant="body2">$3.25</Typography>
                                <Typography variant="body2">$1,300</Typography>
                                <Typography variant="body2">—</Typography>
                              </Box>
                              <Box sx={{
                                display: 'grid',
                                ...
                                <Box>
                                  <Typography variant="body2" sx={{ fontWeight: 600 }}>RAG-001</Typography>
                                  <Typography variant="caption" sx={{ color: '#666' }}>INDUSTRIAL WIPERS - WHITE COTTON RAGS</Typography>
                                </Box>
                                <Typography variant="body2">10 boxes</Typography>
                              ...
                              <Box sx={{
                                ...
                                <Typography variant="body2">50 packs</Typography>
                                <Typography variant="body2">$12.50</Typography>
                                <Typography variant="body2">$625</Typography>
                                <Typography variant="body2">—</Typography>
                              </Box>
                              <Box sx={{
                                display: 'grid',
                                ...
                                <Typography variant="body2">2 boxes</Typography>
                                <Typography variant="body2">$24.00</Typography>
                        ...
                        {/* Notes & Decisions */}
                        <Box sx={{ mb: 3, border: '1px solid #e0e0e0', borderRadius: 1, p: 2, bgcolor: '#fafafa' }}>
                          <Typography variant="subtitle2" sx={{ fontWeight: 600, mb: 1.5, display: 'flex', alignItems: 'center', gap: 1 }}>
                            <InfoIcon sx={{ fontSize: 18, color: '#00446A' }} />
                            NOTES & DECISIONS
                          </Typography>
                          <Box component="ul" sx={{ m: 0, pl: 3 }}>
                            {message.quoteType === 'like-item-vests' ? (
                              <>
                                <Typography component="li" variant="body2" sx={{ color: '#333', mb: 1 }}>
                                  <strong>VES-200 Custom Variant:</strong> 2-color logo printing (navy blue & white, 10x8" centered on back)
                                </Typography>
                                <Typography component="li" variant="body2" sx={{ color: '#333', mb: 1 }}>
                                  <strong>⚠️ Lead Time:</strong> 2-3 weeks (longer than standard due to custom printing)
                                </Typography>
                                <Typography component="li" variant="body2" sx={{ color: '#333', mb: 1 }}>
                                  <strong>MOQ:</strong> 100 units minimum for custom printing (order of 200 units meets requirement)
                                </Typography>
                                <Typography component="li" variant="body2" sx={{ color: '#333', fontStyle: 'italic' }}>
                                  <strong>Pricing Range:</strong> Final costs depend on artwork complexity, ink colors, and placement. Exact pricing requires artwork review and vendor quotes for custom printing setup. Range accounts for potential variation in setup fees ($150-$200) and per-unit printing costs ($2.00-$2.50).
                                </Typography>
                              </>
                            ) : message.quoteType === 'bulk-reorder' ? (
                              <>
                                <Typography component="li" variant="body2" sx={{ color: '#333', mb: 1 }}>
                                  <strong>SKU Clarification:</strong> WIP-100 matched to RAG-001 (INDUSTRIAL WIPERS - WHITE COTTON RAGS)
                                </Typography>
                                <Typography component="li" variant="body2" sx={{ color: '#333', mb: 1 }}>
                                  <strong>Unit Conversion:</strong> Requested 25 rolls, converted to 2 boxes (12 rolls per box = 24 rolls total, close to original request)
                                </Typography>
                              ...
                              <>
                                <Typography component="li" variant="body2" sx={{ color: '#333', mb: 1 }}>
                                  <strong>GLV-250:</strong> Budgetary range — pricing based on similar products in catalog
                                </Typography>
                                <Typography component="li" variant="body2" sx={{ color: '#333' }}>
                                  <strong>MOQ Decision:</strong> Accept pricing at current quantity (Requested 15 cases, MOQ 20 cases — adjusted to meet minimum)
                                </Typography>
                              </>
                            )}
                          </Box>
...
Quote Accuracy:
The range is designed to provide budget certainty while accommodating these real-world variables. Once you confirm specifications, preferred delivery timeline, and payment terms, we can narrow this to a firm quote with ±2% variance.
...
Reply with your preferences on timeline and specifications, and I'll provide a refined estimate within 24 hours.`,
                    ...
                    {!message.isHeadsUp && !message.isSuccess && !message.isQuote && !message.isProgress && !message.isAttachment && !message.isProductTable && (
                      <>
                        <Typography
                          variant="body2"
                          sx={{
                            mb: message.showGenerateQuoteButton ? 2 : 0.5,
                        ...
                        {message.showGenerateQuoteButton && (
                          <Button
                            variant="contained"
                            onClick={() => {
                              setMessages(prev => [...prev, {
                                type: 'user',
                                text: 'Yes, generate quote',
                                timestamp: new Date().toLocaleTimeString('en-US', { hour: 'numeric', minute: '2-digit' })
                              }])
                              handleGenerateQuoteFromDemo()
                            }}
                            sx={{
                              bgcolor: '#00446A',
                              textTransform: 'none',
              ...
              {currentStep === 3 && (
                ...
                >
                  ...
                  <Typography variant="subtitle2" sx={{ fontWeight: 600 }}>
                    MOQ Not Met — Minimum 20 Cases Required
                  </Typography>

                  <Typography variant="body2" sx={{ color: '#333' }}>
                    WORK GLOVES - LEATHER PALM requires a minimum order of 20 cases. You requested 15 cases. Please select an option to proceed.
                  </Typography>

                  <Stack direction="row" spacing={2} flexWrap="wrap">
                    <Button
                      variant={moqSelection === 1 ? "contained" : "outlined"}
                      onClick={handleMOQOption1}
                      disabled={moqSelection !== null}
                      sx={{
                        bgcolor: moqSelection === 1 ? '#00446A' : 'transparent',
                        borderColor: moqSelection === null ? '#00446A' : moqSelection === 1 ? '#00446A' : 'rgba(0, 68, 106, 0.3)',
                        color: moqSelection === 1 ? '#fff' : moqSelection === null ? '#00446A' : 'rgba(0, 68, 106, 0.5)',
                        textTransform: 'none',
                        borderRadius: '4px',
                        padding: '10px 20px',
                        '&:hover': {
                          bgcolor: moqSelection === 1 ? '#003350' : 'rgba(0, 68, 106, 0.04)',
                          borderColor: '#003350'
                        },
                        '&.Mui-disabled': {
                          borderColor: moqSelection === 1 ? '#00446A' : 'rgba(0, 68, 106, 0.3)',
                          bgcolor: moqSelection === 1 ? '#00446A' : 'transparent',
                          color: moqSelection === 1 ? '#fff' : 'rgba(0, 68, 106, 0.5)'
                        }
                      }}
                    >
                      Accept pricing at current quantity
                    </Button>
                    <Button
                      variant={moqSelection === 2 ? "contained" : "outlined"}
                      onClick={handleMOQOption2}
                      disabled={moqSelection !== null}
                      startIcon={workflowIndicator === 'moq-increase' ? (
                        <Box
                          sx={{
                            width: 8,
                            height: 8,
                      ...
                      sx={{
                        bgcolor: moqSelection === 2 ? '#00446A' : 'transparent',
                        borderColor: moqSelection === null ? '#00446A' : moqSelection === 2 ? '#00446A' : 'rgba(0, 68, 106, 0.3)',
                        color: moqSelection === 2 ? '#fff' : moqSelection === null ? '#00446A' : 'rgba(0, 68, 106, 0.5)',
                        textTransform: 'none',
                        borderRadius: '4px',
                        padding: '10px 20px',
                        '&:hover': {
                          bgcolor: moqSelection === 2 ? '#003350' : 'rgba(0, 68, 106, 0.04)',
                          borderColor: '#003350'
                        },
                        '&.Mui-disabled': {
                          borderColor: moqSelection === 2 ? '#00446A' : 'rgba(0, 68, 106, 0.3)',
                          bgcolor: moqSelection === 2 ? '#00446A' : 'transparent',
                          color: moqSelection === 2 ? '#fff' : 'rgba(0, 68, 106, 0.5)'
                        }
                      }}
                    >
                    ...
                    <Button
                      variant={moqSelection === 3 ? "contained" : "outlined"}
                      onClick={handleMOQOption3}
                      disabled={moqSelection !== null}
                      sx={{
                        bgcolor: moqSelection === 3 ? '#00446A' : 'transparent',
                        borderColor: moqSelection === null ? '#00446A' : moqSelection === 3 ? '#00446A' : 'rgba(0, 68, 106, 0.3)',
                        color: moqSelection === 3 ? '#fff' : moqSelection === null ? '#00446A' : 'rgba(0, 68, 106, 0.5)',
                        textTransform: 'none',
                        borderRadius: '4px',
                        padding: '10px 20px',
                        '&:hover': {
                          bgcolor: moqSelection === 3 ? '#003350' : 'rgba(0, 68, 106, 0.04)',
                          borderColor: '#003350'
                        },
                        '&.Mui-disabled': {
                          borderColor: moqSelection === 3 ? '#00446A' : 'rgba(0, 68, 106, 0.3)',
                          bgcolor: moqSelection === 3 ? '#00446A' : 'transparent',
                          color: moqSelection === 3 ? '#fff' : 'rgba(0, 68, 106, 0.5)'
                        }
                      }}
                    >
              ...
              {(currentStep === 4 || currentStep === 7 || currentStep === 15 || currentStep === 22 || currentStep === 29) && (
                ...
                >
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                    {(workflowIndicator === 'generate-quote' || workflowIndicator === 'generate-quote-bulk') && (
                      <Box
                        sx={{
                          width: 8,
                          height: 8,
                    ...
                    <Typography
                      variant="body1"
                      onClick={handleGenerateQuoteFromDemo}
                      sx={{
                        color: '#00446A',
                        cursor: 'pointer',
                        '&:hover': {
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                    {workflowIndicator === 'add-more-items' && (
                      <Box
                        sx={{
                          width: 8,
                          height: 8,
                  ...
                  {currentStep === 15 ? (
                    <>
                      ...
                      >
                        Affordable Option: Standard Safety Vests (no custom printing)
                      </Typography>
                      ...
                      >
                        Often Purchased Together: Safety Glasses
                      </Typography>
                    </>
                  ) : (
                    <>
                      ...
                      >
                        Affordable Option: Basic Kraft Boxes
                      </Typography>
                      ...
                      >
                        Common Add-on: Standard Corrugated RSC
                      </Typography>
                      ...
                      >
                        Often Purchased Together: Economy B-Flute Boxes
                      </Typography>
                    </>
                  )}
              ...
              {false && currentStep === 7 && (
                ...
                >
                    ...
                    <Box sx={{
                      ...
                      <Typography variant="body2" sx={{ fontWeight: 600 }}>Apex</Typography>
                    ...
                    <Box sx={{ mb: 3 }}>
                      ...
                      <Box sx={{
                        ...
                        <Typography variant="body2" sx={{ color: '#333', lineHeight: 1.7 }}>
                          Apex's shipment mix is heavily weighted toward CVS (68% of volume), with consistent pallet counts across lanes. The geographic spread is national but concentrated in the Midwest and East Coast. Recommended approach: tiered pricing by retailer channel with volume incentives for CVS expansion.
                        </Typography>
                      </Box>
                    </Box>
        ...
        >
          <Box sx={{ display: 'flex', gap: 1, alignItems: 'flex-end', maxWidth: 1200, mx: 'auto' }}>
            ...
            <IconButton
              onClick={() => {
                if (chatInput.trim()) {
                  // Check if we're in the find-like-items demo mode
                  if (messages.length === 0 && currentStep === 0 && selectedClient) {
                    // Step 0: Initial product search (or like-item pricing initial, or bulk reorder)
                    if (workflowIndicator === 'send-like-item-initial') {
                      handleLikeItemPricingInitialSubmit()
                    } else if (workflowIndicator === 'send-bulk-initial') {
                      handleBulkReorderSubmit()
                    } else {
                      handleFindLikeItemsDemoSubmit()
                    }
                  } else if (currentStep === 1 && selectedClient) {
                    // Step 1: Item selection
                    handleItemSelectionSubmit()
                  } else if (currentStep === 2 && selectedClient) {
                    // Step 2: Quantity submission
                    handleQuantitySubmit()
                  } else if (currentStep === 5 && selectedClient) {
                    // Step 5: Second product search (add more items)
                    handleSecondProductSearch()
                  } else if (currentStep === 6 && selectedClient) {
                    // Step 6: Second item selection
                    handleSecondItemSelection()
                  } else if (currentStep === 11 && selectedClient) {
                    // Step 11: Like-item quantity submission
                    handleLikeItemQuantitySubmit()
                  } else if (currentStep === 12 && selectedClient) {
                    // Step 12: Like-item variant submission
                    handleLikeItemVariantSubmit()
                  } else if (currentStep === 13 && selectedClient) {
                    // Step 13: Like-item confirm submission
                    handleLikeItemConfirmSubmit()
                  } else if (currentStep === 20 && selectedClient) {
                    // Step 20: Bulk item selection
                    handleBulkItemSelection()
      ...
      {/* Find Like Item Modal */}
      <Dialog
        open={findItemModalOpen}
        onClose={handleCloseFindItem}
        maxWidth="md"
        fullWidth
      >
        <DialogTitle sx={{ bgcolor: '#f5f5f5', borderBottom: '1px solid #e0e0e0', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
            <InventoryIcon sx={{ color: '#00446A' }} />
            <Typography variant="h6" sx={{ fontWeight: 600 }}>Find Like Item</Typography>
          </Box>
          <IconButton onClick={handleCloseFindItem} size="small">
            <CloseIcon />
          </IconButton>
        </DialogTitle>
          ...
          <Box sx={{ mb: 3 }}>
            ...
            <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap' }}>
              <Chip
                ...
                sx={{ bgcolor: selectedCategory === 'all' ? '#00446A' : undefined }}
              />
              <Chip
                label="Janitorial"
                onClick={() => setSelectedCategory('Janitorial')}
                color={selectedCategory === 'Janitorial' ? 'primary' : 'default'}
                sx={{ bgcolor: selectedCategory === 'Janitorial' ? '#00446A' : undefined }}
              />
              <Chip
                label="Safety"
                onClick={() => setSelectedCategory('Safety')}
                color={selectedCategory === 'Safety' ? 'primary' : 'default'}
                sx={{ bgcolor: selectedCategory === 'Safety' ? '#00446A' : undefined }}
              />
              <Chip
                label="Packaging"
                onClick={() => setSelectedCategory('Packaging')}
                color={selectedCategory === 'Packaging' ? 'primary' : 'default'}
                sx={{ bgcolor: selectedCategory === 'Packaging' ? '#00446A' : undefined }}
              />
              <Chip
                label="Material Handling"
                onClick={() => setSelectedCategory('Material Handling')}
                color={selectedCategory === 'Material Handling' ? 'primary' : 'default'}
                sx={{ bgcolor: selectedCategory === 'Material Handling' ? '#00446A' : undefined }}
              />
            </Box>
          </Box>
              ...
              .map(item => (
                <Box
                  ...
                  sx={{
                    ...
                    mb: 1,
                    border: '1px solid',
                    borderColor: selectedItem?.id === item.id ? '#00446A' : '#e0e0e0',
                    borderRadius: 1,
                    bgcolor: selectedItem?.id === item.id ? '#f0f7fa' : 'white',
                    cursor: 'pointer',
                    '&:hover': {
                      bgcolor: selectedItem?.id === item.id ? '#f0f7fa' : '#f9f9f9'
                    }
                  }}
                >
                ...
                <FormControl fullWidth>
                  ...
                  >
                    {selectedItem.variants.map((variant, idx) => (
                      <MenuItem key={idx} value={variant}>{variant}</MenuItem>
                    ))}
                  </Select>
                </FormControl>
                <TextField
        ...
        <DialogActions sx={{ p: 2, borderTop: '1px solid #e0e0e0' }}>
          <Button onClick={handleCloseFindItem}>Cancel</Button>
          <Button
            onClick={handleAddItemToQuote}
            variant="contained"
            disabled={!selectedItem || !itemVariant}
            sx={{
              bgcolor: '#00446A',
